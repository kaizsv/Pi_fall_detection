...
# Custom Imports
from pycomms_1 import PyComms_1
...
class MPU6050:
    ...
    def dmpGetAccGyro(self, packet, data):
        for sig in [16, 20, 24, 28, 32, 36]:
            if packet[sig] > 127:
                packet[sig] -= 256

        data[3] = (packet[16] << 8) + packet[17]
        data[4] = (packet[20] << 8) + packet[21]
        data[5] = (packet[24] << 8) + packet[25]
